...
| [`LiteLLM_PyPI_Supply_Chain_Compromise`](LiteLLM_PyPI_Supply_Chain_Compromise) | Hunt package for the March 2026 LiteLLM PyPI supply-chain compromise, including startup-hook execution, secret theft, exfiltration staging, and Kubernetes follow-on risk | KQL-based scoping, persistence validation, and credential-rotation prioritization |
| [`Trivy_Ecosystem_Supply_Chain_Compromise`](Trivy_Ecosystem_Supply_Chain_Compromise) | Hunt package for the March 2026 Trivy ecosystem compromise, with March 19 runner theft, Docker follow-on, OpenVSX context, and CanisterWorm separation | Workflow scoping, runner-memory theft validation, Docker exposure review, and cluster-aware response guidance |
